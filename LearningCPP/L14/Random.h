...
#ifndef REPLITREPO_RANDOM_H
#define REPLITREPO_RANDOM_H
...
namespace Random
{
    ...
    std::mt19937 mt{ generate() }; // generates a seeded std::mt19937 and copies it into our global object
